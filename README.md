...
export default defineNuxtConfig({
  ...
  metaPixel: {
    pixelIds: 'YOUR_PIXEL_ID', // or ['PIXEL_1', 'PIXEL_2']
    autoTrackPageView: true, // default: true
    debug: true, // Enable styled console logs (default: false)
    enableLocalhost: true, // Enable tracking on localhost (default: false)
  },
});
```
...
<template>
  <button @click="meta.track('AddToCart', { value: 29.99, currency: 'USD' })">
    Add to Cart
  </button>
</template>
```
